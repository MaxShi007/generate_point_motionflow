...
class Flow2Dataset(Flow2Residual):
    ...
    def __init__(self, config_file='flow2dataset.yaml'):
        ...
        self.dataset_form=self.config['dataset_form']
    ...
    def load_flow_data(self,velo_file_id):
        ...
        Loads flow data
        """
        flow_data = np.load(self.flow_files[velo_file_id])
        # print(flow_data)
    ...
    def save_pointpwc_flow_dataset_file():
        pass
        ...
        for sequence in self.process_sequences_list:
            ...
            for velo_file_id in tqdm(range(1,len(self.velo_files))):
                ...
                if self.save_dataset:
                    assert self.dataset_form in ['nsfp','pointpwc']
                    if self.dataset_form=='nsfp':
